import { getCommandLineHelp, mapCommandLineArgs } from '../bin/cli-helper';
  ...
  describe('Getting help and parse arguments:', function () {
    ...
    describe('Command line help:', function () {
      ...
      it('Return help content', function () {
        ...
        expect(getCommandLineHelp('foo', requiredArgs, possibleArgs)).toEqual(help);
      });
    ...
    describe('Map command line argument:', function () {
      ...
      if (typeof jasmineRequire === 'undefined') {
        ...
        it('Flag argument, alias', function () {
          ...
          process.argv.push('-v');
          expect(mapCommandLineArgs({}, possibleArgs)).toEqual({version: true});
          process.argv.pop();
        });
        ...
        it('Number argument, long form', function () {
          ...
          expect(mapCommandLineArgs({}, possibleArgs)).toEqual({spaces: 5});
        ...
        it('String argument, long form', function () {
          ...
          expect(mapCommandLineArgs({}, possibleArgs)).toEqual({name: 'Foo'});
          process.argv.pop(); process.argv.pop();
        });
        ...
        it('File argument, long form', function () {
          ...
          expect(mapCommandLineArgs({}, possibleArgs)).toEqual({input: 'test.txt'});
          process.argv.pop(); process.argv.pop();
        });
        ...
        it('Argument not proceeded with dash', function () {
          var possibleArgs = [{arg: 'version', alias: 'v', type: 'flag', option: 'version', desc: 'Display version.'}];
          process.argv.push('v');
          expect(mapCommandLineArgs({}, possibleArgs)).not.toEqual({version: true});
          process.argv.pop();
        });
        ...
        it('Incomplete compound argument, long form', function () {
          ...
          expect(mapCommandLineArgs({}, possibleArgs)).toEqual({});
          process.argv.pop();
        });
